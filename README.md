...
需要将编译好的文件通过ssh放进设备中（先安装编译软件，进入https://developer.arm.com/downloads/-/gnu-a/10-3-2021-07，
下载gcc-arm-10.3-2021.07-mingw-w64-i686-aarch64-none-linux-gnu.tar.xz并安装，
将目录放进系统环境变量path）：
